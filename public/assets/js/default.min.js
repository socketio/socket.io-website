...
function setHeaderHeight(){$("#screen-fill").css("height",$(window).height()-50)}function slug(t){return t.replace(new RegExp(" ","g"),"-").toLowerCase()}function refreshHash(){var t=document.location.hash;document.location.hash="#"+t,document.location.hash=t}function hashLinks(){var t;t=$("body").hasClass("single")?$("#content").find("h1, h2, h3"):$(".with-sidebar").find("h1, h2");for(var n=0;n<t.length;n++){var e=t.eq(n);if(!e.hasClass("entry-title")&&!e.hasClass("excerpt-title")){var i=slug(e.text()),a=$("<a>",{class:"icon-link deep-link",href:window.location.href.split("#")[0]+"#"+i,style:"position: absolute; margin-left: -18px; text-decoration: none; color: #999;",html:"#"});e.attr("id",i).prepend(a)}refreshHash()}}function setSubscribe(){$(".mc4wp-form").off("submit").submit(function(t){t.preventDefault();var n=$(this),e=$(this).find("input#mc4wp_email"),i={};return n.find("input[type=hidden]").each(function(t,n){var e=$(n);i[e.attr("name")]=$(n).val()}),$.post(window.location.href,$.extend(i,{EMAIL:e.val()})).done(function(t){e.val("");for(var i=$.parseHTML(t),a=0;a<i.length;a++)if("page"==i[a].id){var o=$(i[a]).find(".mc4wp-form");return void n.html(o.html())}e.attr("placeholder","Thanks!")}).fail(function(){e.val(""),e.attr("placeholder","Error")}),!1})}function initNavMenu(){$(".navigation-class").click(function(){$(".class-details").addClass("hidden"),$(this).siblings().removeClass("hidden")})}$(document).ready(function(){FastClick.attach(document.body),setSubscribe(),hashLinks(),initNavMenu()}),$(document).ready(setHeaderHeight),$(window).resize(setHeaderHeight),function(){var t=!1,n=-1,e=$('<span id="slack-count">'),i=$("#menu-item-972 a");io("https://socketio-slack-count.now.sh").on("active",function(a,o){a!==n&&(e.text(a),i.attr("title",a+" users online now of "+o+" registered"),e.removeClass().addClass("animated bounce").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){$(this).removeClass()}),n=a),$(".slack-users-count").text(a),$(".slack-users-count-total").text(o),t||(t=!0,i.append(e))})}();