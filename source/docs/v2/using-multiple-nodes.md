...
permalink: /docs/v2/using-multiple-nodes/
release: v2
type: docs
order: 205
---
...
Now that you have multiple Socket.IO nodes accepting connections, if you want to broadcast events to everyone (or even everyone in a certain [room](/docs/v2/rooms/)) you&#8217;ll need some way of passing messages between processes or computers.
...
If you want to pass messages to it from non-socket.io processes, you should look into [&#8220;Sending messages from the outside-world&#8221;](/docs/v2/rooms/#Sending-messages-from-the-outside-world).
