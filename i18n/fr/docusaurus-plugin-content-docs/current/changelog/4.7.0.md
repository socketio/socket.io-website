...
#### Support for WebTransport {#support-for-webtransport}
...
#### Client bundles with CORS headers {#client-bundles-with-cors-headers}
...
#### Support for WebTransport {#support-for-webtransport-1}
...
#### Cookie management for the Node.js client {#cookie-management-for-the-nodejs-client}
...
#### Conditional import of the ESM build with debug logs {#conditional-import-of-the-esm-build-with-debug-logs}
